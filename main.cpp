...
void displaySendString(char str[15]);
void spiSendByte(int eightbits);
void initDisplay(void);
void displaySendChar(char Charakter);
...
char font[256][8]={
{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},  // 0x00 // Ascii tabelle in Hex
...
{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}   // 0xFF
    ...
    for (int i = 1; i < 9; i++){               // For schleife für 4 Pixelbahnen für Zahl / Buchstabe
        ...
        for (int y = 1; y < 9; y++){  
            ...
            uBit.io.P15.setDigitalValue(DATA);
            spiSendByte(0xF8);                          // Farbe des Pixels
            spiSendByte(0x00);
            }
            else{
    ...
    spiSendByte(0x00);                          // Leerzeile zwischen Buchstaben
...
void displaySendString(char str[15]){
    ...
    uBit.io.P15.setDigitalValue(INSTRUCTION);
    spiSendByte(0x2C);                          // Datenübertragung ankündigen auf gesetzten Cursor


    for(int i = 0; i <= 14; i++){

        displaySendChar(str[i]);
